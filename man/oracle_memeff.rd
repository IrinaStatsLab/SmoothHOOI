...
\arguments{
  ...
  \item{smooth_tnsr}{
  A multi-dimensional array of dimension a*b*n, which contains the smooth, complete ground-truth data.
}
  \item{rank_grid}{
...
%%  If it is a LIST, use
\item{error}{A matrix of losses of M; rows representing ranks, cols representing lambda}
